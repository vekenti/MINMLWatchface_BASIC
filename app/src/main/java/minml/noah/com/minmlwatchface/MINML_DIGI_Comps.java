...
/**
 * The watch-side config activity for {@link MINML_DIGI}, which allows for setting
 * the left and right complications of watch face.
 */
public class MINML_DIGI_Comps extends Activity implements View.OnClickListener {
    ...
    /**
     * Used by associated watch face ({@link MINML_DIGI}) to let this
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLeftComplicationId =
                MINML_DIGI.getComplicationId(ComplicationLocation.LEFT);
        mRightComplicationId =
                MINML_DIGI.getComplicationId(ComplicationLocation.RIGHT);

        mWatchFaceComponentName =
                new ComponentName(getApplicationContext(), MINML_DIGI.class);
    ...
    public void retrieveInitialComplicationsData() {
        ...
        final int[] complicationIds = MINML_DIGI.getComplicationIds();
    ...
    private void launchComplicationHelperActivity(ComplicationLocation complicationLocation) {
        ...
        mSelectedComplicationId =
                MINML_DIGI.getComplicationId(complicationLocation);

        if (mSelectedComplicationId >= 0) {

            int[] supportedTypes =
                    MINML_DIGI.getSupportedComplicationTypes(
            ...
            startActivityForResult(
                    ComplicationHelperActivity.createProviderChooserHelperIntent(
                            ...
                            mSelectedComplicationId,
                            supportedTypes),
                    MINML_DIGI_Comps.COMPLICATION_CONFIG_REQUEST_CODE);
